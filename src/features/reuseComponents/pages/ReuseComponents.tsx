...
const ReuseComponents = () => {
  ...
  const copyToClipboard = (text: string) => {
    ...
    toast.success(t('components.codeCopied'));
  };

  return (
    <div className="container mx-auto px-4 py-6 max-w-7xl">
      <div className="mb-8">
        <h1 className="text-4xl font-baloo font-bold text-primary mb-4">{t('components.title')}</h1>
              ...
              <Card key={component.id} variant="enhanced" className="overflow-hidden">
                ...
                <CardContent className="space-y-6">
                  ...
                  {component.props.length > 0 && (
                    <div>
                      <h4 className="text-lg font-semibold mb-3 font-baloo">{t('components.props')}</h4>
                  ...
                  <div className="space-y-4">
                    <h4 className="text-lg font-semibold font-baloo">{t('components.examples')}</h4>
